        ...
        <div class="d-flex justify-content-end">
            <form class="d-flex flex-wrap align-items-center" role="search">
              <div class="input-group">
                <input type="text" class="form-control mt-2 mx-2 mb-2" id="search" name="search" placeholder="Search">
          ...
          <div class="table-responsive">
            <table class="table table-hover table-striped" id="rentstall">
              <caption class="text-center">List of Tenants</caption>
              <thead>
                <tr>
                  <th scope="col">ID</th>
                  ...
                  <th scope="col">
                    <button type="button" class="btn btn-outline-success bill-button bill-btn" data-bs-toggle="modal" data-bs-target="#AllBillModal">All Bills</button>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="Tenant Actions">
                      ...
                      <button type="button" class="btn btn-success bill-button bill-btn" data-bs-toggle="modal" data-bs-target="#billModal" data-row-id="{{ $rents->id }}" data-fullName="{{ $rents->fullname }}" data-contact="{{ $rents->contact }}" data-emailadd="{{ $rents->emailadd }}" data-payment="{{ $rents->payment }}" data-totalamount="{{ $rents->totalamount }}" data-rentstall_id="{{ $rents->id }}">Bill</button>
                    </div>
                  </td>
                </tr>
                @endforeach
