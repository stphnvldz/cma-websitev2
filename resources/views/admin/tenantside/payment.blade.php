    ...
    <div class="d-flex justify-content-center row">
        <div class="text-center col-6">
            <div class="mb-4 row">
                ...
                <div class="col-sm-8">
                <input type="fullname" name="fullname" class="form-control" id="fullname">
                </div>
            </div>
            <div class="mb-4 row">
                <label for="inputPayment4" class="col-sm-4 col-form-label align-self-center">Stall Number</label>
                <div class="col-sm-8">
                <input type="fullname" name="stallnumber" class="form-control" id="stallnumber">
                </div>
            </div>
            <div class="mb-4 row">
                <label for="inputPayment4" class="col-sm-4 col-form-label align-self-center">Contact Number</label>
                <div class="col-sm-8">
                <input type="fullname" name="contactnumber" class="form-control" id="contactnumber">
                </div>
            </div>
            <div class="mb-2 row">
                <label for="inputPayment4" class="col-sm-4 col-form-label align-self-center">Date</label>
                <div class="col-sm-8">
                <input type="fullname" name="date" class="form-control" id="date">
                </div>
            </div>
        </div>
    </div>
...
<div class="d-flex justify-content-center">
  ...
  <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="paymentMethod" id="codPaymentRadio" value="cash">
    ...
    <div class="modal fade" id="gcash-modal" tabindex="-1" aria-labelledby="gcash-modal" aria-hidden="true">
      ...
      <div class="modal fade" id="codPayment-modal" tabindex="-1" aria-labelledby="codPayment-modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="codPayment-modal">Cash Payment</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="d-flex justify-content-center row">
